...
import { PopoverRoot, PopoverTrigger, PopoverContent } from "@/components/Popover";
    ...
    <div className="mx-auto w-full max-w-7xl space-y-6 px-1">
      ...
      <header className="flex flex-wrap items-center justify-between gap-3">
        ...
        <PopoverRoot className="justify-end">
          <PopoverTrigger className="gap-1.5 rounded-md text-xs font-medium">
            <span className="inline-flex items-center gap-1.5">
              <Sparkles className="h-3.5 w-3.5" />
              Gerenciar cards
            </span>
          </PopoverTrigger>
          <PopoverContent className="!h-auto !w-64 !rounded-lg p-2 shadow-lg">
